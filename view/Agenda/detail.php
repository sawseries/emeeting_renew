...
<script type="text/javascript" src="./front/master/master_element.js?key=<?php echo time(); ?>"></script>
                ...
                <div class="container" id="page-content-wrapper" style='padding:0;'>
                   <div class="row white one" style="min-height:1200px;padding-bottom:50px;overflow-x:auto;">    
                    ...
                    <div class="text" style="text-align:left;padding:0.5em;width:80%;margin:0 auto;">
                    <?=$meeting["detail"];?>
                    </div>
                    <div class="text" style="text-align:left;padding:0.5em;width:80%;margin:0 auto;">
