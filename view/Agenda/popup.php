                    ...
                    <table class="tbl_term table_border" style="width:100%;" >
                            ...
                            <tr id="tr_file_insert_root" style="display:none;">
                                ...
                                <td>
                                    ...
                                    <div id='div_file_root' style='width:100%;'>
                                        <input type='file' id='txt_file_root' name='txt_file_root' >
                                        ttt
                                    </div>
                                </td>
                            </tr>
                        ...
                        <tr>
                            ...
                            <tr id="tr_edit_root_file_present">
                                ...
                                <td>
                                    ...
                                    <span id='text_edit_root_file_present'></span> <a onclick='file_present_toggle("root");' style='color:blue;cursor:pointer;'><b>แก้ไข</b></a> <a style='color:red;cursor:pointer;' onclick='delete_file_present("root");'><b>ลบ</b></a>
                                    </div>
                            ...
                            <tr id="tr_file_edit_root" class="displaynone">
                                ...
                                <td>
                                    ...
                                    <input type="hidden" class="form-control" id="hdn_edit_root_file" name="hdn_edit_root_file" value='0'>
                                    <input type="file" id="txt_file_edit_root" name="txt_file_edit_root" style="margin-left:10px;">
                                    </div>
                                </td>
                            </tr>    
                    ...
                    <div class='loader' id='loader_insert_sub' style='display:none;'></div>
                        <table class="tbl_term border" style="width:100%;">
                            ...
                            <tr id="tr_sub_file" class="displaynone">
                                ...
                                <input type="file" id="txt_sub_file" name="txt_sub_file">
                                </td>
                            </tr>
                            <tr>
                                <td></td>
                        ...
                        <tr>
                            ...
                            <tr id="tr_edit_sub_file_present">
                                ...
                                <td>
                                    ...
                                    <span id='text_edit_sub_file_present'></span> <a onclick='file_present_toggle("sub");' style='color:blue;cursor:pointer;'><b>แก้ไข</b></a> <a style='color:red;cursor:pointer;' onclick='delete_file_present("sub");'><b>ลบ</b></a>
                                    </div>
                            ...
                            <tr id="tr_file_edit_sub" class="displaynone">
                                ...
                                <td>
                                    ...
                                    <div id='div_file_edit_sub' style='width:100%;'>
                                        <input type="hidden" class="form-control" id="hdn_edit_sub_file" name="hdn_edit_sub_file" value='0'>
                                        <input type="file" id="txt_file_edit_sub" name="txt_file_edit_sub" style="margin-left:10px;">
                                    </div>
                                </td>
                            </tr>    
