            ...
            <table class="tbl_term" border="1">
                ...
                <?php foreach ($lists as $list) { ?>
                  ...
                  <?php if($list["doc_type"]=='1'){ ?>
                          <tr class='link' onclick="window.location='./index.php?controller=Agenda&action=edit_agenda&code=<?= $list["code"]; ?>'">
                          <?php }else if($list["doc_type"]=='2'){ ?>
                          <tr class='link' onclick="window.location='./index.php?controller=Report&action=edit_report&code=<?= $list["code"]; ?>'">  
                  <?php } ?>
